...
if (manifest.runtime.launch?.executable !== '${installRoot}/bin/hermes' || JSON.stringify(manifest.runtime.launch.args) !== JSON.stringify(['acp'])) throw new Error('Hermes managed launch contract changed');
