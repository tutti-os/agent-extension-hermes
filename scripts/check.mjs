...
if (manifest.schemaVersion !== 'tutti.agent.manifest.v2' || manifest.agentKey !== 'hermes' || manifest.version !== '1.0.8') throw new Error('invalid manifest identity');
if (manifest.maskIcon !== undefined) throw new Error('Hermes must use its primary icon for conversation rows');
const expectedInstall = ['tool', 'install', 'hermes-agent[acp,mcp]==0.18.2'];
